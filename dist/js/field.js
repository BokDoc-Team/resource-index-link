...
Nova.booting(function (Vue, router) {
    Vue.component('index-resource-index-link', __webpack_require__(3));
    Vue.component('detail-resource-index-link', __webpack_require__(6));
    Vue.component('form-resource-index-link', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        safeFieldPrefix: function safeFieldPrefix() {
            return typeof this.field.prefix !== 'undefined' ? this.field.prefix : '';
        },
        safeFieldSuffix: function safeFieldSuffix() {
            return typeof this.field.suffix !== 'undefined' ? this.field.suffix : '';
        },
        safeFieldValue: function safeFieldValue() {
            var value = this.field.value;

            var fieldPrefix = this.safeFieldPrefix;
            var fieldSuffix = this.safeFieldSuffix;

            return fieldPrefix + value + fieldSuffix;
        },
        safeFieldKey: function safeFieldKey() {
            return typeof this.field.fieldKey !== 'undefined' ? this.field.fieldKey : 'id';
        },
        safeFieldId: function safeFieldId() {
            var key = this.safeFieldKey;

            return typeof this.field[key] !== 'undefined' ? this.field[key] : this.field.id;
        }
    }
});
          ...
          _c(
            ...
            [
              _c(
                ...
                [_vm._v(_vm._s(_vm.safeFieldValue))]
              )
            ],
            1
          )
